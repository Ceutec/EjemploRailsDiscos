...
class DiscosControllerTest < ActionController::TestCase
  ...
  test "should create disco" do
    assert_difference('Disco.count') do
      post :create, disco: { autor: @disco.autor, descripcion: @disco.descripcion, imagen: @disco.imagen, titulo: @disco.titulo }
    end
  ...
  test "should update disco" do
    patch :update, id: @disco, disco: { autor: @disco.autor, descripcion: @disco.descripcion, imagen: @disco.imagen, titulo: @disco.titulo }
    assert_redirected_to disco_path(assigns(:disco))
  end
